    ...
    >
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          to take <span className="text-purple">your </span>
        ...
        <Link
          href="https://mail.google.com/mail/?view=cm&fs=1&to=abdolrahmanalazhary@gmail.com"
          target="_blank"
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light mb-6 md:mb-0 text-white-200">
          Copyright © 2025 Abdurrahman Al-Azhari
        </p>
